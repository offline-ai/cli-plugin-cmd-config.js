...
_See code: [src/commands/config/index.ts](https://github.com/offline-ai/cli-plugin-cmd-config.js/blob/v0.1.1/src/commands/config/index.ts)_
...
_See code: [src/commands/config/save.ts](https://github.com/offline-ai/cli-plugin-cmd-config.js/blob/v0.1.1/src/commands/config/save.ts)_
<!-- commandsstop -->
